...
(function() {
    ...
    var footStepJson = {
        ...
        terrainTag1: {
            interval: 1,
            walk1   : {name: '', volume: 40, pitch: 100, pan: 0},
            walk2   : {name: '', volume: 40, pitch: 100, pan: 0},
            dash1   : {name: '', volume: 40, pitch: 150, pan: 0},
            dash2   : {name: '', volume: 40, pitch: 150, pan: 0},
        },
        ...
        region1    : {
            interval: 2,
            walk1   : {name: '水音11', volume: 50, pitch: 120, pan: 0},
            walk2   : {name: '水音11', volume: 50, pitch: 120, pan: 0},
            dash1   : {name: '水音11', volume: 50, pitch: 150, pan: 0},
            dash2   : {name: '水音11', volume: 50, pitch: 150, pan: 0},
        },
        
        // リージョン 2 通過時の足音（2以降はコピーするか以下の通り値を変更してください）
        // region1 → region2
        region2    : {
            interval: 1,
            walk1   : {name: '水音8', volume: 90, pitch: 100, pan: 0},
            walk2   : {name: '水音8', volume: 90, pitch: 100, pan: 0},
            dash1   : {name: '水音8', volume: 90, pitch: 150, pan: 0},
            dash2   : {name: '水音8', volume: 90, pitch: 150, pan: 0},
        },

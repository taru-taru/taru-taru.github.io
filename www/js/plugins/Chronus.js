...
(function() {
    ...
    var settings = {
        ...
        timeZone: [
            ...
            {name: '深', start: 0, end: 4, timeId: 0},
            {name: '早', start: 5, end: 6, timeId: 1},
            {name: '朝', start: 7, end: 11, timeId: 2},
            {name: '昼', start: 12, end: 16, timeId: 3},
            {name: '夕', start: 17, end: 18, timeId: 4},
            {name: '夜', start: 19, end: 21, timeId: 5},
            {name: '深', start: 22, end: 24, timeId: 0}
        ],
        /* timeTone:時間帯ごとの色調 */
        timeTone: [
            /* timeId:時間帯ID value:色調[赤(-255...255),緑(-255...255),青(-255...255),グレー(0...255)] */
            {timeId: 0, value: [-62, -62, -28, 62]},
            {timeId: 1, value: [-38, -38, 0, 0]},
            {timeId: 2, value: [0, 0, 0, 0]},
            {timeId: 3, value: [5, 5, 5, 0]},
            {timeId: 4, value: [10, -24, -24, 0]},
            {timeId: 5, value: [-48, -48, 0, 38]}
        ]
    };
    //=============================================================================
    // ユーザ書き換え領域 - 終了 -
